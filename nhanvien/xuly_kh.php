<?php 
		if (isset($_POST["txtTen"])){
			...
			$sql="INSERT INTO taikhoan (`TENNGUOIDUNG`,`MATKHAU`,`NGAYTAO`,`TK_LOAI`)VALUES('$dienthoai','$mk',now(),'khách hàng')";
			if (mysqli_query($conn,$sql)){
				$sql1="INSERT INTO khachhang (`KH_MA`,`KH_HOTEN`,`KH_GIOITINH`,`KH_NGAYSINH`,`KH_DIACHI`,`KH_SDT`,`KH_EMAIL`,`KH_CANNANG`,`KH_CHIEUCAO`,`KH_NGAYCAPNHAT`,`KH_NGAYTAO`,`KH_LOAIDA`,`KH_THANGSINH`,`KH_NAMSINH`,`KH_TRANGTHAI`,`TENNGUOIDUNG`,`NQ_MA`) VALUES ('$idkh','$ten','$gioitinh',$ngay_sinh,'$diachi','$dienthoai','$email',$cannang,$chieucao,null,now(),'$loaida',$thang_sinh,$nam_sinh,'1','$dienthoai','NQ01')";
