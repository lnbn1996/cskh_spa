<?php
		if (isset($_POST["txtTen"])){
			...
			$mk="1234567";
			$mkMD5=md5($mk);
			$sql="INSERT INTO taikhoan (`TENNGUOIDUNG`,`MATKHAU`,`NGAYTAO`,`TK_LOAI`)VALUES('$dienthoai','$mkMD5',now(),'nhân viên')";
			if (mysqli_query($conn,$sql)){
				$sql1="INSERT INTO nhanvien (`NV_MA`,`NV_HOTEN`,`NV_GIOITINH`,`NV_DIACHI`,`NV_SDT`,`NV_EMAIL`,`NV_NGAYSINH`,`NV_THANGSINH`,`NV_NAMSINH`,`NV_TRANGTHAI`,`TENNGUOIDUNG`,`NQ_MA`) VALUES ('$idnv','$ten','$gioitinh','$diachi','$dienthoai','$email','$ngay_sinh','$thang_sinh','$nam_sinh','1','$dienthoai','$nq')";
